'''
1) Escreva um programa em Python que faça um CRUD em uma 
lista de dicionários, os quais devem conter os seguintes dados:
a) Código;
b) Nome;
c) Curso;
d) Disciplina;
e) Faltas;
f) 3 checkpoints (lista de float).
...
OBS: o programa deverá ter, obrigatoriamente, a função “main” e 
cada operação do CRUD deverá ser uma função. 
Além das 4 funções do CRUD, acrescente a função da ordenação “Bubble Sort” 
para realizar a ordenação da lista pela chave “Nome” do dicionário e 
a Busca Binária para fazer a busca pala chave “Nome”.
'''
